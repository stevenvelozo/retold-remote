 ...
 */
I.stemmer=(t={ational:"ate",tional:"tion",enci:"ence",anci:"ance",izer:"ize",bli:"ble",alli:"al",entli:"ent",eli:"e",ousli:"ous",ization:"ize",ation:"ate",ator:"ate",alism:"al",iveness:"ive",fulness:"ful",ousness:"ous",aliti:"al",iviti:"ive",biliti:"ble",logi:"log"},i={icate:"ic",ative:"",alize:"al",iciti:"ic",ical:"ic",ful:"",ness:""},s="^("+(r="[^aeiou][^aeiouy]*")+")?"+(a=(o="[aeiouy]")+"[aeiou]*")+r+"("+a+")?$",l="^("+r+")?"+a+r+a+r,c="^("+r+")?"+o,d=new RegExp("^("+r+")?"+a+r),p=new RegExp(l),u=new RegExp(s),h=new RegExp(c),f=/^(.+?)(ss|i)es$/,m=/^(.+?)([^s])s$/,v=/^(.+?)eed$/,g=/^(.+?)(ed|ing)$/,y=/.$/,b=/(at|bl|iz)$/,w=new RegExp("([^aeiouylsz])\\1$"),x=new RegExp("^"+r+o+"[^aeiouwxy]$"),C=/^(.+?[^aeiou])y$/,k=/^(.+?)(ational|tional|enci|anci|izer|bli|alli|entli|eli|ousli|ization|ation|ator|alism|iveness|fulness|ousness|aliti|iviti|biliti|logi)$/,A=/^(.+?)(icate|ative|alize|iciti|ical|ful|ness)$/,D=/^(.+?)(al|ance|ence|er|ic|able|ible|ant|ement|ment|ent|ou|ism|ate|iti|ous|ive|ize)$/,E=/^(.+?)(s|t)(ion)$/,S=/^(.+?)e$/,P=/ll$/,_=new RegExp("^"+r+o+"[^aeiouwxy]$"),F=function(e){var n,o,r,a,s,l,c;if(e.length<3)return e;if("y"==(r=e.substr(0,1))&&(e=r.toUpperCase()+e.substr(1)),s=m,(a=f).test(e)?e=e.replace(a,"$1$2"):s.test(e)&&(e=e.replace(s,"$1$2")),s=g,(a=v).test(e)){var F=a.exec(e);(a=d).test(F[1])&&(a=y,e=e.replace(a,""))}else s.test(e)&&(n=(F=s.exec(e))[1],(s=h).test(n)&&(l=w,c=x,(s=b).test(e=n)?e+="e":l.test(e)?(a=y,e=e.replace(a,"")):c.test(e)&&(e+="e")));return(a=C).test(e)&&(e=(n=(F=a.exec(e))[1])+"i"),(a=k).test(e)&&(n=(F=a.exec(e))[1],o=F[2],(a=d).test(n)&&(e=n+t[o])),(a=A).test(e)&&(n=(F=a.exec(e))[1],o=F[2],(a=d).test(n)&&(e=n+i[o])),s=E,(a=D).test(e)?(n=(F=a.exec(e))[1],(a=p).test(n)&&(e=n)):s.test(e)&&(n=(F=s.exec(e))[1]+F[2],(s=p).test(n)&&(e=n)),(a=S).test(e)&&(n=(F=a.exec(e))[1],s=u,l=_,((a=p).test(n)||s.test(n)&&!l.test(n))&&(e=n)),s=p,(a=P).test(e)&&s.test(e)&&(a=y,e=e.replace(a,"")),"y"==r&&(e=r.toLowerCase()+e.substr(1)),e},function(t){return t.update(F)}),I.Pipeline.registerFunction(I.stemmer,"stemmer"),
/*!
 * lunr.stopWordFilter
 * Copyright (C) 2020 Oliver Nightingale
 */
