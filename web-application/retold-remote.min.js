 ...
 * Copyright (C) 2020 Oliver Nightingale
 */
I.Index=function(t){this.invertedIndex=t.invertedIndex,this.fieldVectors=t.fieldVectors,this.tokenSet=t.tokenSet,this.fields=t.fields,this.pipeline=t.pipeline},I.Index.prototype.search=function(t){return this.query(function(e){new I.QueryParser(t,e).parse()})},I.Index.prototype.query=function(t){for(var e=new I.Query(this.fields),i=Object.create(null),o=Object.create(null),n=Object.create(null),r=Object.create(null),s=Object.create(null),a=0;a<this.fields.length;a++)o[this.fields[a]]=new I.Vector;t.call(e,e);for(a=0;a<e.clauses.length;a++){var l=e.clauses[a],d=null,c=I.Set.empty;d=l.usePipeline?this.pipeline.runString(l.term,{fields:l.fields}):[l.term];for(var p=0;p<d.length;p++){var h=d[p];l.term=h;var u=I.TokenSet.fromClause(l),m=this.tokenSet.intersect(u).toArray();if(0===m.length&&l.presence===I.Query.presence.REQUIRED){for(var f=0;f<l.fields.length;f++){r[P=l.fields[f]]=I.Set.empty}break}for(var g=0;g<m.length;g++){var v=m[g],b=this.invertedIndex[v],y=b._index;for(f=0;f<l.fields.length;f++){var w=b[P=l.fields[f]],C=Object.keys(w),x=v+"/"+P,A=new I.Set(C);if(l.presence==I.Query.presence.REQUIRED&&(c=c.union(A),void 0===r[P]&&(r[P]=I.Set.complete)),l.presence!=I.Query.presence.PROHIBITED){if(o[P].upsert(y,l.boost,function(t,e){return t+e}),!n[x]){for(var R=0;R<C.length;R++){var D,E=C[R],S=new I.FieldRef(E,P),T=w[E];void 0===(D=i[S])?i[S]=new I.MatchData(v,P,T):D.add(v,P,T)}n[x]=!0}}else void 0===s[P]&&(s[P]=I.Set.empty),s[P]=s[P].union(A)}}}if(l.presence===I.Query.presence.REQUIRED)for(f=0;f<l.fields.length;f++){r[P=l.fields[f]]=r[P].intersect(c)}}var F=I.Set.complete,_=I.Set.empty;for(a=0;a<this.fields.length;a++){var P;r[P=this.fields[a]]&&(F=F.intersect(r[P])),s[P]&&(_=_.union(s[P]))}var k=Object.keys(i),L=[],M=Object.create(null);if(e.isNegated()){k=Object.keys(this.fieldVectors);for(a=0;a<k.length;a++){S=k[a];var B=I.FieldRef.fromString(S);i[S]=new I.MatchData}}for(a=0;a<k.length;a++){var V=(B=I.FieldRef.fromString(k[a])).docRef;if(F.contains(V)&&!_.contains(V)){var H,N=this.fieldVectors[B],j=o[B.fieldName].similarity(N);if(void 0!==(H=M[V]))H.score+=j,H.matchData.combine(i[B]);else{var O={ref:V,score:j,matchData:i[B]};M[V]=O,L.push(O)}}}return L.sort(function(t,e){return e.score-t.score})},I.Index.prototype.toJSON=function(){var t=Object.keys(this.invertedIndex).sort().map(function(t){return[t,this.invertedIndex[t]]},this),e=Object.keys(this.fieldVectors).map(function(t){return[t,this.fieldVectors[t].toJSON()]},this);return{version:I.version,fields:this.fields,fieldVectors:e,invertedIndex:t,pipeline:this.pipeline.toJSON()}},I.Index.load=function(t){var e={},i={},o=t.fieldVectors,n=Object.create(null),r=t.invertedIndex,s=new I.TokenSet.Builder,a=I.Pipeline.load(t.pipeline);t.version!=I.version&&I.utils.warn("Version mismatch when loading serialised index. Current version of lunr '"+I.version+"' does not match serialized index '"+t.version+"'");for(var l=0;l<o.length;l++){var d=(p=o[l])[0],c=p[1];i[d]=new I.Vector(c)}for(l=0;l<r.length;l++){var p,h=(p=r[l])[0],u=p[1];s.insert(h),n[h]=u}return s.finish(),e.fields=t.fields,e.fieldVectors=i,e.invertedIndex=n,e.tokenSet=s.root,e.pipeline=a,new I.Index(e)},
/*!
 * lunr.Builder
 * Copyright (C) 2020 Oliver Nightingale
 */
