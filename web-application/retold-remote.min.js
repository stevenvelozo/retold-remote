 ...
 * @license MIT
 */
e.exports={_buildEbookHTML:function(t,e,i){return'<div class="retold-remote-ebook-wrap"><div class="retold-remote-ebook-toc collapsed" id="RetoldRemote-EbookTOC"><div class="retold-remote-ebook-toc-header"><span>Contents</span><button class="retold-remote-ebook-toc-close" onclick="pict.views[\'RetoldRemote-MediaViewer\'].toggleEbookTOC()" title="Close">&times;</button></div><div class="retold-remote-ebook-toc-items" id="RetoldRemote-EbookTOCItems"></div></div><div class="retold-remote-ebook-reader"><div class="retold-remote-ebook-content" id="RetoldRemote-EbookContent"><div class="retold-remote-ebook-loading">Loading ebook...</div></div><div class="retold-remote-ebook-controls"><button class="retold-remote-ebook-toc-btn" onclick="pict.views[\'RetoldRemote-MediaViewer\'].toggleEbookTOC()">&#9776; TOC</button><button class="retold-remote-ebook-page-btn" onclick="pict.views[\'RetoldRemote-MediaViewer\'].ebookPrevPage()">&larr; Prev</button><button class="retold-remote-ebook-page-btn" onclick="pict.views[\'RetoldRemote-MediaViewer\'].ebookNextPage()">Next &rarr;</button><span style="flex:1;"></span><button class="retold-remote-ebook-page-btn" onclick="pict.views[\'RetoldRemote-MediaViewer\'].ebookSaveSelection()">&#128190; Save Selection</button><button class="retold-remote-ebook-page-btn" id="RetoldRemote-EbookRegionSelectBtn" onclick="pict.views[\'RetoldRemote-MediaViewer\'].ebookToggleRegionSelect()">&#9986; Select Region</button></div><div class="retold-remote-ebook-controls" id="RetoldRemote-EbookLabelInput" style="display:none;"><input type="text" id="RetoldRemote-EbookLabelField" placeholder="Label..." style="flex:1; padding:4px 8px; background:var(--retold-bg-secondary, #2d2d2d); color:var(--retold-text-primary, #d4d4d4); border:1px solid var(--retold-border, #444); border-radius:4px;" onkeydown="if(event.key===\'Enter\'){pict.views[\'RetoldRemote-MediaViewer\'].ebookSaveLabel();}"><button class="retold-remote-ebook-page-btn" onclick="pict.views[\'RetoldRemote-MediaViewer\'].ebookSaveLabel()">Save</button><button class="retold-remote-ebook-page-btn" onclick="pict.views[\'RetoldRemote-MediaViewer\'].ebookCancelSelection()">Cancel</button></div></div></div>'},_loadEbookViewer:function(t,e){let i=this;if("mobi"===e.replace(/^.*\./,"").toLowerCase()){if(!(this.pict.AppData.RetoldRemote.ServerCapabilities||{}).ebook_convert){let e=document.getElementById("RetoldRemote-EbookContent");return void(e&&(e.innerHTML='<div class="retold-remote-ebook-loading">MOBI viewing requires Calibre (ebook-convert) on the server.<br><a href="'+t+'" target="_blank" style="color: var(--retold-accent); margin-top: 12px; display: inline-block;">Download file</a></div>'))}let o=document.getElementById("RetoldRemote-EbookContent");o&&(o.innerHTML='<div class="retold-remote-ebook-loading">Converting MOBI to EPUB...</div>');let n=this.pict.providers["RetoldRemote-Provider"],r=n?n._getPathParam(e):encodeURIComponent(e);fetch("/api/media/ebook-convert?path="+r).then(t=>t.json()).then(t=>{if(!t||!t.Success)throw new Error(t?t.Error:"Conversion failed.");let e="/api/media/ebook/"+t.CacheKey+"/"+t.OutputFilename;i._renderEpub(e)}).catch(e=>{let o=document.getElementById("RetoldRemote-EbookContent");o&&(o.innerHTML='<div class="retold-remote-ebook-loading">Failed to convert: '+i.pict.providers["RetoldRemote-FormattingUtilities"].escapeHTML(e.message)+'<br><a href="'+t+'" target="_blank" style="color: var(--retold-accent); margin-top: 12px; display: inline-block;">Download file</a></div>')})}else this._renderEpub(t)},_renderEpub:function(t){let e=this;if("undefined"==typeof window||"function"!=typeof window.ePub){let t=document.getElementById("RetoldRemote-EbookContent");return void(t&&(t.innerHTML='<div class="retold-remote-ebook-loading">epub.js library not loaded.</div>'))}if(this._activeBook){try{this._activeBook.destroy()}catch(t){}this._activeBook=null,this._activeRendition=null}let i=document.getElementById("RetoldRemote-EbookContent");i&&(i.innerHTML="",fetch(t).then(t=>{if(!t.ok)throw new Error("HTTP "+t.status);return t.arrayBuffer()}).then(t=>{let o=window.ePub(t);e._activeBook=o;let n=o.renderTo(i,{width:"100%",height:"100%",spread:"none"});e._activeRendition=n,n.display(),n.themes.default({body:{color:"var(--retold-text-primary, #d4d4d4)",background:"var(--retold-bg-primary, #1e1e1e)","font-family":'Georgia, "Times New Roman", serif',"line-height":"1.6",padding:"20px 40px"},a:{color:"var(--retold-accent, #569cd6)"}}),o.loaded.navigation.then(t=>{e._renderEbookTOC(t.toc)})}).catch(t=>{i&&(i.innerHTML='<div class="retold-remote-ebook-loading">Failed to load ebook: '+e.pict.providers["RetoldRemote-FormattingUtilities"].escapeHTML(t.message)+"</div>")}))},_renderEbookTOC:function(t){let e=document.getElementById("RetoldRemote-EbookTOCItems");if(!e||!t)return;let i=this,o="",n=function(t,e){for(let r=0;r<t.length;r++){let s=t[r],a=e>0?" indent-"+Math.min(e,2):"";o+='<button class="retold-remote-ebook-toc-item'+a+'" data-href="'+i.pict.providers["RetoldRemote-FormattingUtilities"].escapeHTML(s.href)+"\" onclick=\"pict.views['RetoldRemote-MediaViewer'].ebookGoToChapter(this.getAttribute('data-href'))\">"+i.pict.providers["RetoldRemote-FormattingUtilities"].escapeHTML(s.label.trim())+"</button>",s.subitems&&s.subitems.length>0&&n(s.subitems,e+1)}};n(t,0),e.innerHTML=o},ebookGoToChapter:function(t){this._activeRendition&&t&&this._activeRendition.display(t)},ebookPrevPage:function(){this._activeRendition&&this._activeRendition.prev()},ebookNextPage:function(){this._activeRendition&&this._activeRendition.next()},toggleEbookTOC:function(){let t=document.getElementById("RetoldRemote-EbookTOC");t&&t.classList.toggle("collapsed")},ebookSaveSelection:function(){if(!this._activeRendition)return void this.pict.providers["RetoldRemote-ToastNotification"].showToast("No ebook loaded.");let t=this._activeRendition.getContents();if(!t||t.length<1)return void this.pict.providers["RetoldRemote-ToastNotification"].showToast("Unable to access ebook contents.");let e=t[0].document.getSelection(),i=e?e.toString():"";if(!i||0===i.trim().length)return void this.pict.providers["RetoldRemote-ToastNotification"].showToast("Select text first.");let o="";try{let i=e.getRangeAt(0);o=t[0].cfiFromRange(i)}catch(t){this.pict.log.warn("Could not derive CFI from selection: "+t.message)}let n=this._activeRendition.currentLocation(),r=n&&n.start?n.start.index:-1,s="";try{let t=document.querySelectorAll("#RetoldRemote-EbookTOCItems .retold-remote-ebook-toc-item");if(t.length>0&&r>=0){s=t[Math.min(r,t.length-1)].textContent.trim()}}catch(t){}this._pendingEbookSelection={Type:"text-selection",CFI:o,SpineIndex:r,ChapterTitle:s,SelectedText:i};let a=document.getElementById("RetoldRemote-EbookLabelInput");a&&(a.style.display="");let l=document.getElementById("RetoldRemote-EbookLabelField");l&&(l.value="",l.focus())},ebookToggleRegionSelect:function(){let t=this,e=document.getElementById("RetoldRemote-EbookContent"),i=document.getElementById("RetoldRemote-EbookRegionSelectBtn");if(!e)return;let o=document.getElementById("RetoldRemote-EbookRegionOverlay");if(o)return o.remove(),i&&(i.style.background=""),void(this._ebookRegionActive=!1);this._ebookRegionActive=!0,i&&(i.style.background="var(--retold-accent, #569cd6)");let n=document.createElement("div");n.id="RetoldRemote-EbookRegionOverlay",n.style.cssText="position:absolute; top:0; left:0; width:100%; height:100%; cursor:crosshair; z-index:100; user-select:none;",e.style.position="relative",e.appendChild(n);let r=!1,s=0,a=0,l=null;n.addEventListener("mousedown",function(t){t.preventDefault(),t.stopPropagation();let e=document.getElementById("RetoldRemote-EbookRegionRect");e&&e.remove();let i=n.getBoundingClientRect();s=t.clientX-i.left,a=t.clientY-i.top,r=!0,l=document.createElement("div"),l.id="RetoldRemote-EbookRegionRect",l.style.cssText="position:absolute; border:2px dashed var(--retold-accent, #569cd6); background:rgba(86, 156, 214, 0.15); pointer-events:none;",l.style.left=s+"px",l.style.top=a+"px",l.style.width="0px",l.style.height="0px",n.appendChild(l)}),n.addEventListener("mousemove",function(t){if(!r||!l)return;t.preventDefault();let e=n.getBoundingClientRect(),i=t.clientX-e.left,o=t.clientY-e.top,d=Math.min(s,i),c=Math.min(a,o),p=Math.abs(i-s),h=Math.abs(o-a);l.style.left=d+"px",l.style.top=c+"px",l.style.width=p+"px",l.style.height=h+"px"}),n.addEventListener("mouseup",function(e){if(!r||!l)return;e.preventDefault(),r=!1;let i=n.getBoundingClientRect(),o=e.clientX-i.left,d=e.clientY-i.top,c=Math.min(s,o),p=Math.min(a,d),h=Math.abs(o-s),u=Math.abs(d-a);if(h<5||u<5)return void(l&&(l.remove(),l=null));let m=n.offsetWidth,g=n.offsetHeight,f="";try{let e=t._activeRendition.getContents();if(e&&e.length>0){let t=e[0].document,i=t.body;if(i){let e,o=t.createTreeWalker(i,NodeFilter.SHOW_TEXT,null,!1),n=[];for(;e=o.nextNode();){if(!e.textContent||0===e.textContent.trim().length)continue;let i=t.createRange();i.selectNodeContents(e);let o=i.getClientRects();for(let t=0;t<o.length;t++){let i=o[t];if(i.right>=c&&i.left<=c+h&&i.bottom>=p&&i.top<=p+u){n.push(e.textContent.trim());break}}}f=n.join(" ")}}}catch(e){t.pict.log.warn("Region text extraction failed: "+e.message)}let v=t._activeRendition.currentLocation(),b=v&&v.start?v.start.index:-1;t._pendingEbookSelection={Type:"visual-region",X:Math.round(c),Y:Math.round(p),Width:Math.round(h),Height:Math.round(u),ViewportWidth:m,ViewportHeight:g,SpineIndex:b,SelectedText:f};let y=document.getElementById("RetoldRemote-EbookLabelInput");y&&(y.style.display="");let w=document.getElementById("RetoldRemote-EbookLabelField");w&&(w.value="",w.focus())})},ebookCancelSelection:function(){let t=document.getElementById("RetoldRemote-EbookLabelInput");t&&(t.style.display="none");let e=document.getElementById("RetoldRemote-EbookLabelField");e&&(e.value="");let i=document.getElementById("RetoldRemote-EbookRegionRect");i&&i.remove();let o=document.getElementById("RetoldRemote-EbookRegionOverlay");o&&o.remove();let n=document.getElementById("RetoldRemote-EbookRegionSelectBtn");n&&(n.style.background=""),this._ebookRegionActive=!1,this._pendingEbookSelection=null},ebookSaveLabel:function(){let t=this;if(!this._pendingEbookSelection)return void this.pict.providers["RetoldRemote-ToastNotification"].showToast("No selection to save.");let e=document.getElementById("RetoldRemote-EbookLabelField"),i=e?e.value.trim():"";if(!i)return void this.pict.providers["RetoldRemote-ToastNotification"].showToast("Enter a label for the selection.");let o=this._pendingEbookSelection;o.Label=i;let n={Path:this.pict.AppData.RetoldRemote.CurrentViewerFile,Region:o};fetch("/api/media/subimage-regions",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)}).then(t=>{if(!t.ok)throw new Error("HTTP "+t.status);return t.json()}).then(e=>{t.pict.providers["RetoldRemote-ToastNotification"].showToast("Selection saved: "+i),t.ebookCancelSelection(),"function"==typeof t.refreshSubimageRegions&&t.refreshSubimageRegions()}).catch(e=>{t.pict.providers["RetoldRemote-ToastNotification"].showToast("Failed to save selection: "+e.message),t.pict.log.error("Ebook selection save error: "+e.message)})}}},{}],140:[function(t,e,i){
/**
 ...
 * @license MIT
 */
const o="https://cdnjs.cloudflare.com/ajax/libs/pdf.js/4.9.155/pdf.min.mjs";e.exports={_buildPdfHTML:function(t,e,i){let o="pict.views['RetoldRemote-MediaViewer']",n='<div class="retold-remote-pdf-viewer">';return n+='<div class="retold-remote-pdf-controls" id="RetoldRemote-PdfControls">',n+='<button class="retold-remote-pdf-btn" onclick="'+o+'.pdfPrevPage()" title="Previous page">&larr; Prev</button>',n+='<span class="retold-remote-pdf-page-info">',n+='Page <input type="number" id="RetoldRemote-PdfPageInput" class="retold-remote-pdf-page-input" value="1" min="1" onchange="'+o+".pdfGoToPage(parseInt(this.value,10))\" onkeydown=\"if(event.key==='Enter'){"+o+'.pdfGoToPage(parseInt(this.value,10));event.preventDefault();}">',n+=' of <span id="RetoldRemote-PdfPageCount">0</span>',n+="</span>",n+='<button class="retold-remote-pdf-btn" onclick="'+o+'.pdfNextPage()" title="Next page">Next &rarr;</button>',n+='<span class="retold-remote-pdf-separator"></span>',n+='<button class="retold-remote-pdf-btn" onclick="'+o+'.pdfSaveSelection()" title="Save selected text">&#128190; Save Selection</button>',n+='<button class="retold-remote-pdf-btn" id="RetoldRemote-PdfRegionBtn" onclick="'+o+'.pdfToggleRegionSelect()" title="Select a visual region">&#9986; Select Region</button>',n+='<span class="retold-remote-pdf-separator"></span>',n+='<button class="retold-remote-pdf-btn" onclick="'+o+'.pdfZoomIn()" title="Zoom in (+)">+ Zoom In</button>',n+='<span class="retold-remote-pdf-zoom-label" id="RetoldRemote-PdfZoomLabel">150%</span>',n+='<button class="retold-remote-pdf-btn" onclick="'+o+'.pdfZoomOut()" title="Zoom out (-)">- Zoom Out</button>',n+='<button class="retold-remote-pdf-btn" onclick="'+o+'.pdfZoomFit()" title="Fit to width">Fit</button>',n+="</div>",n+='<div class="retold-remote-pdf-content" id="RetoldRemote-PdfContent">',n+='<div class="retold-remote-pdf-wrap" id="RetoldRemote-PdfWrap">',n+='<canvas id="RetoldRemote-PdfCanvas"></canvas>',n+='<div id="RetoldRemote-PdfTextLayer" class="retold-remote-pdf-text-layer"></div>',n+='<div id="RetoldRemote-PdfSelectionOverlay" class="retold-remote-pdf-selection-overlay" style="display:none;"></div>',n+='<div id="RetoldRemote-PdfRegionOverlays" class="retold-remote-pdf-region-overlays"></div>',n+="</div>",n+='<div class="retold-remote-pdf-loading" id="RetoldRemote-PdfLoading">Loading PDF...</div>',n+="</div>",n+='<div class="retold-remote-pdf-label-bar" id="RetoldRemote-PdfLabelInput" style="display:none;">',n+='<input type="text" id="RetoldRemote-PdfLabelField" class="retold-remote-pdf-label-field" placeholder="Label this selection…" onkeydown="if(event.key===\'Enter\'){'+o+".pdfSaveLabel();event.preventDefault();event.stopPropagation();}if(event.key==='Escape'){"+o+'.pdfCancelSelection();event.preventDefault();event.stopPropagation();}">',n+='<button class="retold-remote-pdf-btn" onclick="'+o+'.pdfSaveLabel()">Save</button>',n+='<button class="retold-remote-pdf-btn" onclick="'+o+'.pdfCancelSelection()">Cancel</button>',n+="</div>",n+="</div>",n+="<style>",n+=".retold-remote-pdf-viewer { display: flex; flex-direction: column; height: 100%; overflow: hidden; }",n+=".retold-remote-pdf-controls { display: flex; align-items: center; gap: 6px; padding: 6px 12px; background: var(--retold-bg-secondary, #252526); border-bottom: 1px solid var(--retold-border, #3e4451); flex-shrink: 0; flex-wrap: wrap; }",n+=".retold-remote-pdf-btn { background: var(--retold-bg-tertiary, #2d2d2d); color: var(--retold-text-primary, #abb2bf); border: 1px solid var(--retold-border, #3e4451); border-radius: 4px; padding: 4px 10px; font-size: 0.78rem; cursor: pointer; white-space: nowrap; }",n+=".retold-remote-pdf-btn:hover { background: var(--retold-bg-hover, #3e4451); }",n+=".retold-remote-pdf-btn.active { background: var(--retold-accent, #569cd6); color: #fff; }",n+=".retold-remote-pdf-page-info { font-size: 0.78rem; color: var(--retold-text-secondary, #8b949e); display: flex; align-items: center; gap: 4px; }",n+=".retold-remote-pdf-page-input { width: 48px; background: var(--retold-bg-input, #1e1e1e); color: var(--retold-text-primary, #abb2bf); border: 1px solid var(--retold-border, #3e4451); border-radius: 4px; padding: 2px 6px; font-size: 0.78rem; text-align: center; }",n+=".retold-remote-pdf-separator { width: 1px; height: 20px; background: var(--retold-border, #3e4451); margin: 0 4px; }",n+=".retold-remote-pdf-zoom-label { font-size: 0.78rem; color: var(--retold-text-secondary, #8b949e); min-width: 40px; text-align: center; }",n+=".retold-remote-pdf-content { flex: 1; overflow: auto; position: relative; background: var(--retold-bg-primary, #1e1e1e); }",n+=".retold-remote-pdf-wrap { position: relative; display: inline-block; margin: 16px auto; }",n+=".retold-remote-pdf-content { text-align: center; }",n+=".retold-remote-pdf-text-layer { position: absolute; top: 0; left: 0; overflow: hidden; opacity: 0.25; line-height: 1.0; }",n+=".retold-remote-pdf-text-layer > span { position: absolute; white-space: pre; color: transparent; }",n+=".retold-remote-pdf-text-layer ::selection { background: rgba(86, 156, 214, 0.4); }",n+=".retold-remote-pdf-selection-overlay { position: absolute; top: 0; left: 0; width: 100%; height: 100%; cursor: crosshair; z-index: 5; }",n+=".retold-remote-pdf-region-overlays { position: absolute; top: 0; left: 0; pointer-events: none; }",n+=".retold-remote-pdf-region-rect { position: absolute; border: 2px solid rgba(86, 156, 214, 0.8); background: rgba(86, 156, 214, 0.12); pointer-events: none; }",n+=".retold-remote-pdf-region-label { position: absolute; bottom: -18px; left: 0; font-size: 0.65rem; color: var(--retold-accent, #569cd6); white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 160px; pointer-events: none; }",n+=".retold-remote-pdf-active-rect { position: absolute; border: 2px dashed rgba(214, 156, 86, 0.9); background: rgba(214, 156, 86, 0.15); pointer-events: none; }",n+=".retold-remote-pdf-loading { position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); font-size: 0.9rem; color: var(--retold-text-secondary, #8b949e); }",n+=".retold-remote-pdf-label-bar { display: flex; align-items: center; gap: 6px; padding: 6px 12px; background: var(--retold-bg-secondary, #252526); border-top: 1px solid var(--retold-border, #3e4451); flex-shrink: 0; }",n+=".retold-remote-pdf-label-field { flex: 1; background: var(--retold-bg-input, #1e1e1e); color: var(--retold-text-primary, #abb2bf); border: 1px solid var(--retold-border, #3e4451); border-radius: 4px; padding: 4px 10px; font-size: 0.78rem; }",n+="</style>",n},_loadPdfViewer:function(t,e){let i=this;this._pdfDocument=null,this._pdfCurrentPage=1,this._pdfPageCount=0,this._pdfScale=1.5,this._pdfSelectionMode=!1,this._pdfSavedRegions=[],this._pdfPendingRegion=null,this._pdfPendingText=null,this._pdfLibLoaded=!1,this._pdfFilePath=e,this._ensurePdfJsLoaded(function(){i._pdfLibLoaded=!0,i._openPdfDocument(t)})},_ensurePdfJsLoaded:function(t){if("undefined"!=typeof window&&window.pdfjsLib)return t();let e,i=this,n=document.getElementById("RetoldRemote-PdfLoading");n&&(n.textContent="Loading PDF renderer...");try{e=new Function("url","return import(url);")}catch(t){e=null}let r=function(e){window.pdfjsLib=e,window.pdfjsLib.GlobalWorkerOptions&&(window.pdfjsLib.GlobalWorkerOptions.workerSrc="https://cdnjs.cloudflare.com/ajax/libs/pdf.js/4.9.155/pdf.worker.min.mjs"),t()},s=function(t){let e=document.getElementById("RetoldRemote-PdfLoading");e&&(e.textContent="Failed to load PDF renderer: "+(t&&t.message?t.message:"unknown error")),i.pict&&i.pict.log&&i.pict.log.error("PDF renderer load failed: "+(t&&t.stack?t.stack:t))};e?e(o).then(r).catch(function(t){i._loadPdfJsViaScriptTag(r,s)}):i._loadPdfJsViaScriptTag(r,s)},_loadPdfJsViaScriptTag:function(t,e){try{let i="__retoldPdfJsResolver_"+Date.now(),n="__retoldPdfJsRejecter_"+Date.now(),r=document.createElement("script");r.type="module",r.textContent='import("'+o+'")  .then(function (m) { window["'+i+'"](m); })  .catch(function (e) { window["'+n+'"](e); });',window[i]=function(e){delete window[i],delete window[n],r.remove(),t(e)},window[n]=function(t){delete window[i],delete window[n],r.remove(),e(t)},document.head.appendChild(r)}catch(t){e(t)}},_openPdfDocument:function(t){let e=this,i=document.getElementById("RetoldRemote-PdfLoading");i&&(i.textContent="Opening PDF..."),window.pdfjsLib.getDocument(t).promise.then(function(t){e._pdfDocument=t,e._pdfPageCount=t.numPages,e._pdfCurrentPage=1;let o=document.getElementById("RetoldRemote-PdfPageCount");o&&(o.textContent=t.numPages);let n=document.getElementById("RetoldRemote-PdfPageInput");n&&(n.max=t.numPages),i&&(i.style.display="none"),e._renderPdfPage(1),e._pdfLoadSavedRegions(e._pdfFilePath)}).catch(function(t){i&&(i.textContent="Failed to open PDF: "+t.message)})},_renderPdfPage:function(t){if(!this._pdfDocument)return;if(t<1||t>this._pdfPageCount)return;let e=this;this._pdfCurrentPage=t,this._pdfDocument.getPage(t).then(function(i){let o=i.getViewport({scale:e._pdfScale}),n=document.getElementById("RetoldRemote-PdfCanvas");if(!n)return;let r=n.getContext("2d");n.width=o.width,n.height=o.height;let s=document.getElementById("RetoldRemote-PdfWrap");s&&(s.style.width=o.width+"px",s.style.height=o.height+"px");let a={canvasContext:r,viewport:o};i.render(a).promise.then(function(){e._renderPdfTextLayer(i,o),e._pdfRenderRegionOverlays()});let l=document.getElementById("RetoldRemote-PdfPageInput");l&&(l.value=t),e._pdfUpdateZoomLabel()}).catch(function(t){let e=document.getElementById("RetoldRemote-PdfLoading");e&&(e.style.display="",e.textContent="Failed to render page: "+t.message)})},_renderPdfTextLayer:function(t,e){let i=document.getElementById("RetoldRemote-PdfTextLayer");i&&(i.innerHTML="",i.style.width=e.width+"px",i.style.height=e.height+"px",t.getTextContent().then(function(t){if(window.pdfjsLib&&window.pdfjsLib.renderTextLayer){window.pdfjsLib.renderTextLayer({textContentSource:t,container:i,viewport:e}).promise.catch(function(){})}else{let o=t.items;for(let t=0;t<o.length;t++){let n=o[t];if(!n.str)continue;let r=document.createElement("span");r.textContent=n.str;let s=n.transform,a=Math.sqrt(s[2]*s[2]+s[3]*s[3]),l=s[4]*(e.width/(e.viewBox[2]-e.viewBox[0])),d=e.height-s[5]*(e.height/(e.viewBox[3]-e.viewBox[1]));r.style.left=l+"px",r.style.top=d-a+"px",r.style.fontSize=a+"px",r.style.fontFamily=n.fontName||"sans-serif",i.appendChild(r)}}}))},_pdfUpdateZoomLabel:function(){let t=document.getElementById("RetoldRemote-PdfZoomLabel");t&&(t.textContent=Math.round(100*this._pdfScale)+"%")},pdfNextPage:function(){this._pdfCurrentPage<this._pdfPageCount&&this._renderPdfPage(this._pdfCurrentPage+1)},pdfPrevPage:function(){this._pdfCurrentPage>1&&this._renderPdfPage(this._pdfCurrentPage-1)},pdfGoToPage:function(t){(isNaN(t)||t<1)&&(t=1),t>this._pdfPageCount&&(t=this._pdfPageCount),this._renderPdfPage(t)},pdfZoomIn:function(){this._pdfScale=Math.min(this._pdfScale+.25,5),this._renderPdfPage(this._pdfCurrentPage)},pdfZoomOut:function(){this._pdfScale=Math.max(this._pdfScale-.25,.25),this._renderPdfPage(this._pdfCurrentPage)},pdfZoomFit:function(){if(!this._pdfDocument)return;let t=this;this._pdfDocument.getPage(this._pdfCurrentPage).then(function(e){let i=document.getElementById("RetoldRemote-PdfContent");if(!i)return;let o=e.getViewport({scale:1}),n=(i.clientWidth-32)/o.width;t._pdfScale=Math.max(.25,Math.min(n,5)),t._renderPdfPage(t._pdfCurrentPage)})},pdfSaveSelection:function(){let t="";if("undefined"!=typeof window&&window.getSelection&&(t=window.getSelection().toString().trim()),!t){let t=this.pict.providers["RetoldRemote-ToastNotification"];return void(t&&t.showToast("Select some text in the PDF first."))}this._pdfPendingText=t,this._pdfPendingRegion=null;let e=document.getElementById("RetoldRemote-PdfLabelInput");e&&(e.style.display="");let i=document.getElementById("RetoldRemote-PdfLabelField");i&&(i.value="",i.placeholder="Label this text selection…",i.focus())},pdfToggleRegionSelect:function(){this._pdfSelectionMode=!this._pdfSelectionMode;let t=document.getElementById("RetoldRemote-PdfSelectionOverlay"),e=document.getElementById("RetoldRemote-PdfRegionBtn");this._pdfSelectionMode?(t&&(t.style.display=""),e&&e.classList.add("active"),this._pdfSetupRegionDrag()):(t&&(t.style.display="none",t.innerHTML=""),e&&e.classList.remove("active"),this._pdfCleanupRegionDrag())},_pdfSetupRegionDrag:function(){let t=this,e=document.getElementById("RetoldRemote-PdfSelectionOverlay");if(!e)return;let i=!1,o=0,n=0,r=null;this._pdfRegionMouseDown=function(t){t.preventDefault(),i=!0;let s=e.getBoundingClientRect();o=t.clientX-s.left,n=t.clientY-s.top,r=document.createElement("div"),r.className="retold-remote-pdf-active-rect",r.style.left=o+"px",r.style.top=n+"px",r.style.width="0px",r.style.height="0px",e.appendChild(r)},this._pdfRegionMouseMove=function(t){if(!i||!r)return;let s=e.getBoundingClientRect(),a=t.clientX-s.left,l=t.clientY-s.top,d=Math.min(o,a),c=Math.min(n,l),p=Math.abs(a-o),h=Math.abs(l-n);r.style.left=d+"px",r.style.top=c+"px",r.style.width=p+"px",r.style.height=h+"px"},this._pdfRegionMouseUp=function(s){if(!i)return;i=!1;let a=e.getBoundingClientRect(),l=s.clientX-a.left,d=s.clientY-a.top,c=Math.min(o,l),p=Math.min(n,d),h=Math.abs(l-o),u=Math.abs(d-n);if(h<5||u<5)return r&&r.parentElement&&r.parentElement.removeChild(r),void(r=null);let m=document.getElementById("RetoldRemote-PdfCanvas");if(!m)return;let g=m.width,f=m.height,v=g/m.offsetWidth,b=f/m.offsetHeight,y=c*v/t._pdfScale,w=p*b/t._pdfScale,C=h*v/t._pdfScale,x=u*b/t._pdfScale;t._pdfPendingRegion={X:Math.round(100*y)/100,Y:Math.round(100*w)/100,Width:Math.round(100*C)/100,Height:Math.round(100*x)/100},t._pdfPendingText=null;let R=document.getElementById("RetoldRemote-PdfLabelInput");R&&(R.style.display="");let A=document.getElementById("RetoldRemote-PdfLabelField");A&&(A.value="",A.placeholder="Label this region…",A.focus())},e.addEventListener("mousedown",this._pdfRegionMouseDown),e.addEventListener("mousemove",this._pdfRegionMouseMove),e.addEventListener("mouseup",this._pdfRegionMouseUp)},_pdfCleanupRegionDrag:function(){let t=document.getElementById("RetoldRemote-PdfSelectionOverlay");t&&(this._pdfRegionMouseDown&&t.removeEventListener("mousedown",this._pdfRegionMouseDown),this._pdfRegionMouseMove&&t.removeEventListener("mousemove",this._pdfRegionMouseMove),this._pdfRegionMouseUp&&t.removeEventListener("mouseup",this._pdfRegionMouseUp)),this._pdfRegionMouseDown=null,this._pdfRegionMouseMove=null,this._pdfRegionMouseUp=null},pdfSaveLabel:function(){let t=document.getElementById("RetoldRemote-PdfLabelField"),e=t?t.value.trim():"",i=this,o=this.pict.providers["RetoldRemote-Provider"],n=(o?o._getPathParam(this._pdfFilePath):encodeURIComponent(this._pdfFilePath),{Path:this._pdfFilePath,Region:{Label:e,PageNumber:this._pdfCurrentPage}});if(this._pdfPendingText)n.Region.Type="text-selection",n.Region.SelectedText=this._pdfPendingText;else{if(!this._pdfPendingRegion)return void this.pdfCancelSelection();n.Region.Type="visual-region",n.Region.X=this._pdfPendingRegion.X,n.Region.Y=this._pdfPendingRegion.Y,n.Region.Width=this._pdfPendingRegion.Width,n.Region.Height=this._pdfPendingRegion.Height}fetch("/api/media/subimage-regions",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)}).then(function(t){return t.json()}).then(function(t){if(t&&t.Success){i._pdfSavedRegions=t.Regions||[],i._pdfRenderRegionOverlays();let o=i.pict.providers["RetoldRemote-ToastNotification"];o&&o.showToast("Selection saved"+(e?": "+e:""));let n=i.pict.views["RetoldRemote-SubimagesPanel"];n&&n.render()}}).catch(function(t){let e=i.pict.providers["RetoldRemote-ToastNotification"];e&&e.showToast("Failed to save selection: "+t.message)}),this._pdfPendingRegion=null,this._pdfPendingText=null;let r=document.getElementById("RetoldRemote-PdfLabelInput");r&&(r.style.display="none");let s=document.getElementById("RetoldRemote-PdfSelectionOverlay");s&&(s.innerHTML="")},pdfCancelSelection:function(){this._pdfPendingRegion=null,this._pdfPendingText=null;let t=document.getElementById("RetoldRemote-PdfLabelInput");t&&(t.style.display="none");let e=document.getElementById("RetoldRemote-PdfSelectionOverlay");e&&(e.innerHTML="")},_pdfLoadSavedRegions:function(t){let e=this,i=this.pict.providers["RetoldRemote-Provider"],o=i?i._getPathParam(t):encodeURIComponent(t);fetch("/api/media/subimage-regions?path="+o).then(function(t){return t.json()}).then(function(t){t&&t.Success&&Array.isArray(t.Regions)&&(e._pdfSavedRegions=t.Regions,e._pdfRenderRegionOverlays())}).catch(function(){})},_pdfRenderRegionOverlays:function(){let t=document.getElementById("RetoldRemote-PdfRegionOverlays");if(!t)return;let e=document.getElementById("RetoldRemote-PdfCanvas");if(!e)return;t.style.width=e.offsetWidth+"px",t.style.height=e.offsetHeight+"px",t.innerHTML="";let i=this._pdfCurrentPage,o=this._pdfScale,n=e.offsetWidth/e.width;for(let e=0;e<this._pdfSavedRegions.length;e++){let r=this._pdfSavedRegions[e];if(r.PageNumber&&r.PageNumber!==i)continue;if("visual-region"!==r.Type)continue;let s=r.X*o*n,a=r.Y*o*n,l=r.Width*o*n,d=r.Height*o*n,c=document.createElement("div");if(c.className="retold-remote-pdf-region-rect",c.style.left=s+"px",c.style.top=a+"px",c.style.width=l+"px",c.style.height=d+"px",r.Label){let t=document.createElement("div");t.className="retold-remote-pdf-region-label",t.textContent=r.Label,c.appendChild(t)}t.appendChild(c)}}}},{}],141:[function(t,e,i){const o=t("pict-view"),n={ViewIdentifier:"RetoldRemote-AudioExplorer",DefaultRenderable:"RetoldRemote-AudioExplorer",DefaultDestinationAddress:"#RetoldRemote-Viewer-Container",AutoRender:!1,CSS:""};class r extends o{constructor(t,e,i){super(t,e,i),this._currentPath="",this._waveformData=null,this._peaks=[],this._viewStart=0,this._viewEnd=1,this._minZoom=.005,this._selectionStart=-1,this._selectionEnd=-1,this._isDragging=!1,this._dragStart=-1,this._cursorX=-1,this._segmentURL=null,this._mainCanvas=null,this._overviewCanvas=null,this._resizeObserver=null}showExplorer(t,e,i){let o=this.pict.AppData.RetoldRemote;o.ActiveMode="audio-explorer",o.CurrentViewerFile=t,o.CurrentViewerMediaType="audio",this._currentPath=t;let n=this.pict.views["ContentEditor-Layout"];n&&"function"==typeof n.notifyCurrentFileChanged&&n.notifyCurrentFileChanged(t),this._waveformData=null,this._peaks=[],this._viewStart=0,this._viewEnd=1,this._segmentURL=null,this._pendingSelectionStartSec="number"==typeof e&&e>=0?e:-1,this._pendingSelectionEndSec="number"==typeof i&&i>=0?i:-1,this._selectionStart=-1,this._selectionEnd=-1;let r=this.pict.providers["RetoldRemote-Provider"],s="#/explore-audio/"+(r?r.getFragmentIdentifier(t):t);0===(window.location.hash||"").indexOf("#/view/")?history.replaceState(null,"",s):window.location.hash=s;let a=document.getElementById("RetoldRemote-Gallery-Container"),l=document.getElementById("RetoldRemote-Viewer-Container");a&&(a.style.display="none"),l&&(l.style.display="block");let d=t.replace(/^.*\//,""),c='<div class="retold-remote-aex">';c+='<div class="retold-remote-aex-header">',c+='<button class="retold-remote-aex-nav-btn" onclick="pict.views[\'RetoldRemote-AudioExplorer\'].goBack()" title="Back (Esc)">&larr; Back</button>',c+='<div class="retold-remote-aex-title">Audio Explorer &mdash; '+this.pict.providers["RetoldRemote-FormattingUtilities"].escapeHTML(d)+"</div>",c+='<div class="retold-remote-aex-actions">',c+='<button class="retold-remote-aex-action-btn" onclick="pict.views[\'RetoldRemote-AudioExplorer\'].playInBrowser()" title="Play in browser">&#9654; Play</button>',c+='<button class="retold-remote-aex-action-btn" onclick="pict.providers[\'RetoldRemote-GalleryNavigation\']._streamWithVLC()" title="Stream with VLC (v)">&#9654; VLC</button>',c+="</div>",c+="</div>",c+='<div class="retold-remote-aex-info" id="RetoldRemote-AEX-Info" style="display:none;"></div>',c+='<div class="retold-remote-aex-controls" id="RetoldRemote-AEX-Controls" style="display:none;">',c+='<button class="retold-remote-aex-btn" onclick="pict.views[\'RetoldRemote-AudioExplorer\'].zoomIn()" title="Zoom In (+)">+ Zoom In</button>',c+='<button class="retold-remote-aex-btn" onclick="pict.views[\'RetoldRemote-AudioExplorer\'].zoomOut()" title="Zoom Out (-)">- Zoom Out</button>',c+='<button class="retold-remote-aex-btn" onclick="pict.views[\'RetoldRemote-AudioExplorer\'].zoomToFit()" title="Zoom to Fit (0)">Fit All</button>',c+='<button class="retold-remote-aex-btn" id="RetoldRemote-AEX-ZoomSelBtn" onclick="pict.views[\'RetoldRemote-AudioExplorer\'].zoomToSelection()" title="Zoom to Selection (Z)" disabled>Zoom to Selection</button>',c+='<button class="retold-remote-aex-btn" id="RetoldRemote-AEX-PlaySelBtn" onclick="pict.views[\'RetoldRemote-AudioExplorer\'].playSelection()" title="Play Selection (Space)" disabled>&#9654; Play Selection</button>',c+='<button class="retold-remote-aex-btn" onclick="pict.views[\'RetoldRemote-AudioExplorer\'].clearSelection()" title="Clear Selection (Esc)">Clear Selection</button>',c+='<span style="border-left:1px solid var(--retold-border);height:20px;margin:0 4px;"></span>',c+='<button class="retold-remote-aex-save-btn" id="RetoldRemote-AEX-SaveSelBtn" onclick="pict.views[\'RetoldRemote-AudioExplorer\'].saveSelectionToCollection()" title="Save segment to collection (s)" disabled>Save Segment</button>',c+="</div>",c+='<div class="retold-remote-aex-body" id="RetoldRemote-AEX-Body">',c+='<div class="retold-remote-aex-loading">',c+='<div class="retold-remote-aex-loading-spinner"></div>',c+="Analyzing audio waveform...",c+="</div>",c+="</div>",c+='<div class="retold-remote-aex-time-bar" id="RetoldRemote-AEX-TimeBar" style="display:none;">',c+='<span class="retold-remote-aex-time-label">View:</span>',c+='<span class="retold-remote-aex-time-value" id="RetoldRemote-AEX-ViewRange">--</span>',c+='<span class="retold-remote-aex-time-label" style="margin-left: 12px;">Selection:</span>',c+='<span class="retold-remote-aex-time-selection" id="RetoldRemote-AEX-SelectionRange">None</span>',c+='<span class="retold-remote-aex-time-label" style="margin-left: 12px;">Cursor:</span>',c+='<span class="retold-remote-aex-time-value" id="RetoldRemote-AEX-CursorTime">--</span>',c+="</div>",c+='<div class="retold-remote-aex-playback" id="RetoldRemote-AEX-Playback" style="display:none;">',c+='<span class="retold-remote-aex-playback-label">Segment:</span>',c+='<audio controls id="RetoldRemote-AEX-Audio"></audio>',c+="</div>",c+="</div>",l&&(l.innerHTML=c);let p=this.pict.views["ContentEditor-TopBar"];p&&p.updateInfo(),this._fetchWaveform(t)}_fetchWaveform(t){let e=this,i=this.pict.providers["RetoldRemote-Provider"],o="/api/media/audio-waveform?path="+(i?i._getPathParam(t):encodeURIComponent(t))+"&peaks=2000";this._cancelActiveOperation();let n=this.pict.providers["RetoldRemote-OperationStatus"],r=n?n.startOperation({Label:"Analyzing audio waveform",Phase:"Extracting peaks…",Cancelable:!0}):null;r&&(this._activeOperationId=r.OperationId,this._activeAbortController=r.AbortController);let s={};r&&r.AbortController&&(s.signal=r.AbortController.signal),r&&(s.headers={"X-Op-Id":r.OperationId}),fetch(o,s).then(t=>t.json()).then(t=>{if(!t||!t.Success)return r&&n&&n.errorOperation(r.OperationId,{message:t?t.Error:"Unknown error"}),void e._showError(t?t.Error:"Unknown error");r&&n&&n.completeOperation(r.OperationId),e._activeOperationId=null,e._activeAbortController=null,e._waveformData=t,e._peaks=t.Peaks||[],e._renderWaveformUI()}).catch(t=>{t&&"AbortError"===t.name||(r&&n&&n.errorOperation(r.OperationId,t),e._showError(t.message))})}_cancelActiveOperation(){if(this._activeAbortController)try{this._activeAbortController.abort()}catch(t){}let t=this.pict.providers["RetoldRemote-OperationStatus"];this._activeOperationId&&t&&t.cancelOperation(this._activeOperationId),this._activeOperationId=null,this._activeAbortController=null}_renderWaveformUI(){let t=this._waveformData;if(!t)return;let e=document.getElementById("RetoldRemote-AEX-Info");if(e){let i="";i+='<span class="retold-remote-aex-info-item"><span class="retold-remote-aex-info-label">Duration</span> <span class="retold-remote-aex-info-value">'+this.pict.providers["RetoldRemote-FormattingUtilities"].escapeHTML(t.DurationFormatted)+"</span></span>",t.SampleRate&&(i+='<span class="retold-remote-aex-info-item"><span class="retold-remote-aex-info-label">Sample Rate</span> <span class="retold-remote-aex-info-value">'+(t.SampleRate/1e3).toFixed(1)+" kHz</span></span>"),t.Channels&&(i+='<span class="retold-remote-aex-info-item"><span class="retold-remote-aex-info-label">Channels</span> <span class="retold-remote-aex-info-value">'+t.Channels+(t.ChannelLayout?" ("+this.pict.providers["RetoldRemote-FormattingUtilities"].escapeHTML(t.ChannelLayout)+")":"")+"</span></span>"),t.Codec&&(i+='<span class="retold-remote-aex-info-item"><span class="retold-remote-aex-info-label">Codec</span> <span class="retold-remote-aex-info-value">'+this.pict.providers["RetoldRemote-FormattingUtilities"].escapeHTML(t.Codec)+"</span></span>"),t.Bitrate&&(i+='<span class="retold-remote-aex-info-item"><span class="retold-remote-aex-info-label">Bitrate</span> <span class="retold-remote-aex-info-value">'+Math.round(t.Bitrate/1e3)+" kbps</span></span>"),t.FileSize&&(i+='<span class="retold-remote-aex-info-item"><span class="retold-remote-aex-info-label">Size</span> <span class="retold-remote-aex-info-value">'+this.pict.providers["RetoldRemote-FormattingUtilities"].formatFileSize(t.FileSize)+"</span></span>"),i+='<span class="retold-remote-aex-info-item"><span class="retold-remote-aex-info-label">Peaks</span> <span class="retold-remote-aex-info-value">'+t.PeakCount+" ("+this.pict.providers["RetoldRemote-FormattingUtilities"].escapeHTML(t.Method)+")</span></span>",e.innerHTML=i,e.style.display=""}let i=document.getElementById("RetoldRemote-AEX-Controls");i&&(i.style.display="");let o=document.getElementById("RetoldRemote-AEX-TimeBar");o&&(o.style.display="");let n=document.getElementById("RetoldRemote-AEX-Body");if(n){let t="";t+='<div class="retold-remote-aex-canvas-wrap" id="RetoldRemote-AEX-CanvasWrap">',t+='<canvas id="RetoldRemote-AEX-MainCanvas"></canvas>',t+="</div>",t+='<div class="retold-remote-aex-overview-wrap" id="RetoldRemote-AEX-OverviewWrap">',t+='<canvas id="RetoldRemote-AEX-OverviewCanvas"></canvas>',t+='<div class="retold-remote-aex-overview-viewport" id="RetoldRemote-AEX-OverviewViewport"></div>',t+="</div>",n.innerHTML=t}this._mainCanvas=document.getElementById("RetoldRemote-AEX-MainCanvas"),this._overviewCanvas=document.getElementById("RetoldRemote-AEX-OverviewCanvas"),this._bindCanvasEvents(),this._resizeCanvases(),this._drawAll(),this._updateTimeDisplay();let r=this;if("undefined"!=typeof ResizeObserver){this._resizeObserver=new ResizeObserver(()=>{r._resizeCanvases(),r._drawAll()});let t=document.getElementById("RetoldRemote-AEX-CanvasWrap");t&&this._resizeObserver.observe(t)}this._loadSavedState()}_resizeCanvases(){if(this._mainCanvas){let t=this._mainCanvas.parentElement;if(t){let e=window.devicePixelRatio||1;this._mainCanvas.width=t.clientWidth*e,this._mainCanvas.height=t.clientHeight*e}}if(this._overviewCanvas){let t=this._overviewCanvas.parentElement;if(t){let e=window.devicePixelRatio||1;this._overviewCanvas.width=t.clientWidth*e,this._overviewCanvas.height=t.clientHeight*e}}}_drawAll(){this._drawMainWaveform(),this._drawOverviewWaveform(),this._updateOverviewViewport()}_drawMainWaveform(){if(!this._mainCanvas||0===this._peaks.length)return;let t=this._mainCanvas.getContext("2d"),e=this._mainCanvas.width,i=this._mainCanvas.height,o=window.devicePixelRatio||1;t.clearRect(0,0,e,i);let n=getComputedStyle(document.documentElement).getPropertyValue("--retold-bg-primary").trim()||"#1e1e2e";t.fillStyle=n,t.fillRect(0,0,e,i);let r=this._peaks,s=r.length,a=Math.floor(this._viewStart*s),l=Math.ceil(this._viewEnd*s)-a;if(l<=0)return;let d=i/2;if(this._selectionStart>=0&&this._selectionEnd>=0){let n=Math.min(this._selectionStart,this._selectionEnd),r=Math.max(this._selectionStart,this._selectionEnd),s=this._viewEnd-this._viewStart,a=(n-this._viewStart)/s*e,l=(r-this._viewStart)/s*e;if(a=Math.max(0,a),l=Math.min(e,l),l>a){let e=getComputedStyle(document.documentElement).getPropertyValue("--retold-accent").trim()||"#89b4fa";t.fillStyle=e+"22",t.fillRect(a,0,l-a,i),t.strokeStyle=e,t.lineWidth=2*o,t.beginPath(),t.moveTo(a,0),t.lineTo(a,i),t.stroke(),t.beginPath(),t.moveTo(l,0),t.lineTo(l,i),t.stroke()}}let c=getComputedStyle(document.documentElement).getPropertyValue("--retold-text-dim").trim()||"#585b70";t.strokeStyle=c,t.lineWidth=1,t.setLineDash([4,4]),t.beginPath(),t.moveTo(0,d),t.lineTo(e,d),t.stroke(),t.setLineDash([]);let p=getComputedStyle(document.documentElement).getPropertyValue("--retold-accent").trim()||"#89b4fa",h=getComputedStyle(document.documentElement).getPropertyValue("--retold-text-secondary").trim()||"#cdd6f4";for(let i=0;i<e;i++){let o=a+i/e*l,n=a+(i+1)/e*l,c=Math.floor(o),u=Math.ceil(n);c=Math.max(0,Math.min(c,s-1)),u=Math.max(c+1,Math.min(u,s));let m=0,g=0;for(let t=c;t<u;t++)r[t].Min<m&&(m=r[t].Min),r[t].Max>g&&(g=r[t].Max);let f=d-g*d*.9,v=d-m*d*.9,b=Math.max(1,v-f),y=this._viewStart+i/e*(this._viewEnd-this._viewStart),w=!1;if(this._selectionStart>=0&&this._selectionEnd>=0){let t=Math.min(this._selectionStart,this._selectionEnd),e=Math.max(this._selectionStart,this._selectionEnd);w=y>=t&&y<=e}t.fillStyle=w?p:h,t.fillRect(i,f,1,b)}this._cursorX>=0&&this._cursorX<e&&(t.strokeStyle="#ffffff44",t.lineWidth=1,t.beginPath(),t.moveTo(this._cursorX*o,0),t.lineTo(this._cursorX*o,i),t.stroke())}_drawOverviewWaveform(){if(!this._overviewCanvas||0===this._peaks.length)return;let t=this._overviewCanvas.getContext("2d"),e=this._overviewCanvas.width,i=this._overviewCanvas.height;t.clearRect(0,0,e,i);let o=getComputedStyle(document.documentElement).getPropertyValue("--retold-bg-tertiary").trim()||"#313244";t.fillStyle=o,t.fillRect(0,0,e,i);let n=this._peaks,r=n.length,s=i/2,a=getComputedStyle(document.documentElement).getPropertyValue("--retold-text-muted").trim()||"#a6adc8";if(this._selectionStart>=0&&this._selectionEnd>=0){let o=Math.min(this._selectionStart,this._selectionEnd),n=Math.max(this._selectionStart,this._selectionEnd),r=getComputedStyle(document.documentElement).getPropertyValue("--retold-accent").trim()||"#89b4fa";t.fillStyle=r+"33",t.fillRect(o*e,0,(n-o)*e,i)}for(let i=0;i<e;i++){let o=i/e*r,l=(i+1)/e*r,d=Math.floor(o),c=Math.ceil(l);d=Math.max(0,Math.min(d,r-1)),c=Math.max(d+1,Math.min(c,r));let p=0,h=0;for(let t=d;t<c;t++)n[t].Min<p&&(p=n[t].Min),n[t].Max>h&&(h=n[t].Max);let u=s-h*s*.85,m=s-p*s*.85,g=Math.max(1,m-u);t.fillStyle=a,t.fillRect(i,u,1,g)}}_updateOverviewViewport(){let t=document.getElementById("RetoldRemote-AEX-OverviewViewport");if(!t)return;let e=document.getElementById("RetoldRemote-AEX-OverviewWrap");if(!e)return;let i=e.clientWidth,o=this._viewStart*i,n=this._viewEnd*i;t.style.left=o+"px",t.style.width=n-o+"px"}_bindCanvasEvents(){let t=this,e=document.getElementById("RetoldRemote-AEX-CanvasWrap");if(!e)return;e.addEventListener("mousemove",i=>{let o=e.getBoundingClientRect();if(t._cursorX=i.clientX-o.left,t._isDragging){let e=t._viewStart+t._cursorX/o.width*(t._viewEnd-t._viewStart);e=Math.max(0,Math.min(1,e)),t._selectionEnd=e,t._drawMainWaveform(),t._drawOverviewWaveform(),t._updateSelectionButtons()}t._updateTimeDisplay(),t._drawMainWaveform()}),e.addEventListener("mouseleave",()=>{t._cursorX=-1,t._drawMainWaveform()}),e.addEventListener("mousedown",i=>{if(0!==i.button)return;let o=e.getBoundingClientRect(),n=t._viewStart+(i.clientX-o.left)/o.width*(t._viewEnd-t._viewStart);n=Math.max(0,Math.min(1,n)),t._isDragging=!0,t._selectionStart=n,t._selectionEnd=n,t._dragStart=n,t._segmentURL=null;let r=document.getElementById("RetoldRemote-AEX-Playback");r&&(r.style.display="none")}),window.addEventListener("mouseup",()=>{t._isDragging&&(t._isDragging=!1,Math.abs(t._selectionEnd-t._selectionStart)<.001&&(t._selectionStart=-1,t._selectionEnd=-1),t._updateSelectionButtons(),t._drawAll(),t._updateTimeDisplay(),t._saveState())}),e.addEventListener("wheel",i=>{i.preventDefault();let o=e.getBoundingClientRect(),n=(i.clientX-o.left)/o.width,r=i.deltaY>0?1.2:.8;t._zoomAtPoint(n,r)},{passive:!1});let i=document.getElementById("RetoldRemote-AEX-OverviewWrap");i&&i.addEventListener("click",e=>{let o=i.getBoundingClientRect(),n=(e.clientX-o.left)/o.width;n=Math.max(0,Math.min(1,n));let r=t._viewEnd-t._viewStart,s=n-r/2;s=Math.max(0,Math.min(1-r,s)),t._viewStart=s,t._viewEnd=s+r,t._drawAll(),t._updateTimeDisplay()})}_zoomAtPoint(t,e){let i=this._viewEnd-this._viewStart,o=this._viewStart+t*i,n=i*e;n=Math.max(this._minZoom,Math.min(1,n));let r=o-t*n,s=r+n;r<0&&(r=0,s=n),s>1&&(s=1,r=1-n),this._viewStart=Math.max(0,r),this._viewEnd=Math.min(1,s),this._drawAll(),this._updateTimeDisplay()}_updateTimeDisplay(){if(!this._waveformData)return;let t=this._waveformData.Duration,e=document.getElementById("RetoldRemote-AEX-ViewRange");if(e){let i=this._viewStart*t,o=this._viewEnd*t;e.textContent=this.pict.providers["RetoldRemote-FormattingUtilities"].formatTimestamp(i,!0)+" - "+this.pict.providers["RetoldRemote-FormattingUtilities"].formatTimestamp(o,!0)}let i=document.getElementById("RetoldRemote-AEX-SelectionRange");if(i)if(this._selectionStart>=0&&this._selectionEnd>=0){let e=Math.min(this._selectionStart,this._selectionEnd)*t,o=Math.max(this._selectionStart,this._selectionEnd)*t,n=o-e;i.textContent=this.pict.providers["RetoldRemote-FormattingUtilities"].formatTimestamp(e,!0)+" - "+this.pict.providers["RetoldRemote-FormattingUtilities"].formatTimestamp(o,!0)+" ("+this.pict.providers["RetoldRemote-FormattingUtilities"].formatTimestamp(n,!0)+")"}else i.textContent="None";let o=document.getElementById("RetoldRemote-AEX-CursorTime");if(o)if(this._cursorX>=0&&this._mainCanvas){let e=this._mainCanvas.parentElement;if(e){let i=this._viewStart+this._cursorX/e.clientWidth*(this._viewEnd-this._viewStart);o.textContent=this.pict.providers["RetoldRemote-FormattingUtilities"].formatTimestamp(i*t,!0)}}else o.textContent="--"}_updateSelectionButtons(){let t=this._selectionStart>=0&&this._selectionEnd>=0&&Math.abs(this._selectionEnd-this._selectionStart)>=.001,e=document.getElementById("RetoldRemote-AEX-ZoomSelBtn");e&&(e.disabled=!t);let i=document.getElementById("RetoldRemote-AEX-PlaySelBtn");i&&(i.disabled=!t);let o=document.getElementById("RetoldRemote-AEX-SaveSelBtn");o&&(o.disabled=!t)}zoomIn(){this._zoomAtPoint(.5,.5)}zoomOut(){this._zoomAtPoint(.5,2)}zoomToFit(){this._viewStart=0,this._viewEnd=1,this._drawAll(),this._updateTimeDisplay()}zoomToSelection(){if(this._selectionStart<0||this._selectionEnd<0)return;let t=Math.min(this._selectionStart,this._selectionEnd),e=Math.max(this._selectionStart,this._selectionEnd),i=.05*(e-t);this._viewStart=Math.max(0,t-i),this._viewEnd=Math.min(1,e+i),this._drawAll(),this._updateTimeDisplay()}clearSelection(){this._selectionStart=-1,this._selectionEnd=-1,this._segmentURL=null;let t=document.getElementById("RetoldRemote-AEX-Playback");t&&(t.style.display="none"),this._updateSelectionButtons(),this._drawAll(),this._updateTimeDisplay(),this._saveState()}_applyPendingSelection(){if(this._pendingSelectionStartSec<0||this._pendingSelectionEndSec<0)return;if(!this._waveformData||!this._waveformData.Duration||this._waveformData.Duration<=0)return;let t=this._waveformData.Duration;this._selectionStart=Math.min(this._pendingSelectionStartSec,this._pendingSelectionEndSec)/t,this._selectionEnd=Math.max(this._pendingSelectionStartSec,this._pendingSelectionEndSec)/t,this._selectionStart=Math.max(0,Math.min(1,this._selectionStart)),this._selectionEnd=Math.max(0,Math.min(1,this._selectionEnd)),this._pendingSelectionStartSec=-1,this._pendingSelectionEndSec=-1}saveSelectionToCollection(){if(this._selectionStart<0||this._selectionEnd<0)return;let t=this.pict.providers["RetoldRemote-CollectionManager"];if(!t)return;let e=t.getQuickAddTargetGUID();if(e)t.addAudioSnippetToCollection(e);else{let e=this._waveformData&&this._waveformData.Duration?this._waveformData.Duration:0,i=Math.round(this._selectionStart*e*100)/100,o=Math.round(this._selectionEnd*e*100)/100;t.setPendingClipContext({Type:"audio-clip",Start:i,End:o});let n=this.pict.views["ContentEditor-TopBar"];n&&"function"==typeof n.showAddToCollectionDropdown&&n.showAddToCollectionDropdown()}}playSelection(){if(this._selectionStart<0||this._selectionEnd<0||!this._waveformData)return;let t=this._waveformData.Duration,e=Math.min(this._selectionStart,this._selectionEnd)*t,i=Math.max(this._selectionStart,this._selectionEnd)*t,o=this.pict.providers["RetoldRemote-Provider"],n="/api/media/audio-segment?path="+(o?o._getPathParam(this._currentPath):encodeURIComponent(this._currentPath))+"&start="+e.toFixed(3)+"&end="+i.toFixed(3)+"&format=mp3",r=document.getElementById("RetoldRemote-AEX-Playback");r&&(r.style.display="");let s=document.getElementById("RetoldRemote-AEX-Audio");s&&(s.src=n,s.load(),s.play().catch(()=>{})),this._segmentURL=n}goBack(){this._cancelActiveOperation(),this._resizeObserver&&(this._resizeObserver.disconnect(),this._resizeObserver=null);let t=this.pict.providers["RetoldRemote-GalleryNavigation"];t&&t.closeViewer()}playInBrowser(){this._resizeObserver&&(this._resizeObserver.disconnect(),this._resizeObserver=null);let t=this.pict.views["RetoldRemote-MediaViewer"];t&&t.showMedia(this._currentPath,"audio")}_saveState(){if(!this._currentPath||!this._waveformData)return;this.pict.providers["RetoldRemote-Provider"];let t=[];if(this._selectionStart>=0&&this._selectionEnd>=0&&Math.abs(this._selectionEnd-this._selectionStart)>=.001){let e=this._waveformData.Duration||0,i=Math.min(this._selectionStart,this._selectionEnd),o=Math.max(this._selectionStart,this._selectionEnd),n=Math.round(i*e*100)/100,r=Math.round(o*e*100)/100,s=this.pict.providers["RetoldRemote-FormattingUtilities"];t.push({Start:i,End:o,StartSeconds:n,EndSeconds:r,Label:s.formatTimestamp(n,!0)+" - "+s.formatTimestamp(r,!0)})}let e={Path:this._currentPath,Selections:t,ViewStart:this._viewStart,ViewEnd:this._viewEnd};fetch("/api/media/audio-explorer-state",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}).catch(()=>{})}_loadSavedState(){let t=this,e=this.pict.providers["RetoldRemote-Provider"],i=e?e._getPathParam(this._currentPath):encodeURIComponent(this._currentPath);fetch("/api/media/audio-explorer-state?path="+i).then(t=>t.json()).then(e=>{if(e&&e.Success&&e.State){let i=e.State;if("number"==typeof i.ViewStart&&"number"==typeof i.ViewEnd&&(t._viewStart=i.ViewStart,t._viewEnd=i.ViewEnd),Array.isArray(i.Selections)&&i.Selections.length>0){let e=i.Selections[0];t._selectionStart=e.Start,t._selectionEnd=e.End}}t._applyPendingSelection(),t._updateSelectionButtons(),t._drawAll(),t._updateTimeDisplay()}).catch(()=>{t._applyPendingSelection(),t._updateSelectionButtons(),t._drawAll(),t._updateTimeDisplay()})}_showError(t){let e=document.getElementById("RetoldRemote-AEX-Body");e&&(e.innerHTML='<div class="retold-remote-aex-error"><div class="retold-remote-aex-error-message">'+this.pict.providers["RetoldRemote-FormattingUtilities"].escapeHTML(t||"An error occurred.")+'</div><button class="retold-remote-aex-nav-btn" onclick="pict.views[\'RetoldRemote-AudioExplorer\'].goBack()">Back to Audio</button></div>')}}r.default_configuration=n,e.exports=r},{"pict-view":88}],142:[function(t,e,i){
/**
