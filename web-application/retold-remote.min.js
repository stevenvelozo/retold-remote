 ...
 * Copyright (C) 2020 Oliver Nightingale
 */
I.Set=function(t){if(this.elements=Object.create(null),t){this.length=t.length;for(var e=0;e<this.length;e++)this.elements[t[e]]=!0}else this.length=0},I.Set.complete={intersect:function(t){return t},union:function(){return this},contains:function(){return!0}},I.Set.empty={intersect:function(){return this},union:function(t){return t},contains:function(){return!1}},I.Set.prototype.contains=function(t){return!!this.elements[t]},I.Set.prototype.intersect=function(t){var e,i,n,o=[];if(t===I.Set.complete)return this;if(t===I.Set.empty)return t;this.length<t.length?(e=this,i=t):(e=t,i=this),n=Object.keys(e.elements);for(var r=0;r<n.length;r++){var a=n[r];a in i.elements&&o.push(a)}return new I.Set(o)},I.Set.prototype.union=function(t){return t===I.Set.complete?I.Set.complete:t===I.Set.empty?this:new I.Set(Object.keys(this.elements).concat(Object.keys(t.elements)))},I.idf=function(t,e){var i=0;for(var n in t)"_index"!=n&&(i+=Object.keys(t[n]).length);var o=(e-i+.5)/(i+.5);return Math.log(1+Math.abs(o))},I.Token=function(t,e){this.str=t||"",this.metadata=e||{}},I.Token.prototype.toString=function(){return this.str},I.Token.prototype.update=function(t){return this.str=t(this.str,this.metadata),this},I.Token.prototype.clone=function(t){return t=t||function(t){return t},new I.Token(t(this.str,this.metadata),this.metadata)},
/*!
 * lunr.tokenizer
 * Copyright (C) 2020 Oliver Nightingale
 */
I.tokenizer=function(t,e){if(null==t||null==t)return[];if(Array.isArray(t))return t.map(function(t){return new I.Token(I.utils.asString(t).toLowerCase(),I.utils.clone(e))});for(var i=t.toString().toLowerCase(),n=i.length,o=[],r=0,a=0;r<=n;r++){var s=r-a;if(i.charAt(r).match(I.tokenizer.separator)||r==n){if(s>0){var l=I.utils.clone(e)||{};l.position=[a,s],l.index=o.length,o.push(new I.Token(i.slice(a,r),l))}a=r+1}}return o},I.tokenizer.separator=/[\s\-]+/,
/*!
 * lunr.Pipeline
 * Copyright (C) 2020 Oliver Nightingale
 */
I.Pipeline=function(){this._stack=[]},I.Pipeline.registeredFunctions=Object.create(null),I.Pipeline.registerFunction=function(t,e){e in this.registeredFunctions&&I.utils.warn("Overwriting existing registered function: "+e),t.label=e,I.Pipeline.registeredFunctions[t.label]=t},I.Pipeline.warnIfFunctionNotRegistered=function(t){t.label&&t.label in this.registeredFunctions||I.utils.warn("Function is not registered with pipeline. This may cause problems when serialising the index.\n",t)},I.Pipeline.load=function(t){var e=new I.Pipeline;return t.forEach(function(t){var i=I.Pipeline.registeredFunctions[t];if(!i)throw new Error("Cannot load unregistered function: "+t);e.add(i)}),e},I.Pipeline.prototype.add=function(){Array.prototype.slice.call(arguments).forEach(function(t){I.Pipeline.warnIfFunctionNotRegistered(t),this._stack.push(t)},this)},I.Pipeline.prototype.after=function(t,e){I.Pipeline.warnIfFunctionNotRegistered(e);var i=this._stack.indexOf(t);if(-1==i)throw new Error("Cannot find existingFn");i+=1,this._stack.splice(i,0,e)},I.Pipeline.prototype.before=function(t,e){I.Pipeline.warnIfFunctionNotRegistered(e);var i=this._stack.indexOf(t);if(-1==i)throw new Error("Cannot find existingFn");this._stack.splice(i,0,e)},I.Pipeline.prototype.remove=function(t){var e=this._stack.indexOf(t);-1!=e&&this._stack.splice(e,1)},I.Pipeline.prototype.run=function(t){for(var e=this._stack.length,i=0;i<e;i++){for(var n=this._stack[i],o=[],r=0;r<t.length;r++){var a=n(t[r],r,t);if(null!=a&&""!==a)if(Array.isArray(a))for(var s=0;s<a.length;s++)o.push(a[s]);else o.push(a)}t=o}return t},I.Pipeline.prototype.runString=function(t,e){var i=new I.Token(t,e);return this.run([i]).map(function(t){return t.toString()})},I.Pipeline.prototype.reset=function(){this._stack=[]},I.Pipeline.prototype.toJSON=function(){return this._stack.map(function(t){return I.Pipeline.warnIfFunctionNotRegistered(t),t.label})},
/*!
 * lunr.Vector
 * Copyright (C) 2020 Oliver Nightingale
 */
I.Vector=function(t){this._magnitude=0,this.elements=t||[]},I.Vector.prototype.positionForIndex=function(t){if(0==this.elements.length)return 0;for(var e=0,i=this.elements.length/2,n=i-e,o=Math.floor(n/2),r=this.elements[2*o];n>1&&(r<t&&(e=o),r>t&&(i=o),r!=t);)n=i-e,o=e+Math.floor(n/2),r=this.elements[2*o];return r==t||r>t?2*o:r<t?2*(o+1):void 0},I.Vector.prototype.insert=function(t,e){this.upsert(t,e,function(){throw"duplicate index"})},I.Vector.prototype.upsert=function(t,e,i){this._magnitude=0;var n=this.positionForIndex(t);this.elements[n]==t?this.elements[n+1]=i(this.elements[n+1],e):this.elements.splice(n,0,t,e)},I.Vector.prototype.magnitude=function(){if(this._magnitude)return this._magnitude;for(var t=0,e=this.elements.length,i=1;i<e;i+=2){var n=this.elements[i];t+=n*n}return this._magnitude=Math.sqrt(t)},I.Vector.prototype.dot=function(t){for(var e=0,i=this.elements,n=t.elements,o=i.length,r=n.length,a=0,s=0,l=0,d=0;l<o&&d<r;)(a=i[l])<(s=n[d])?l+=2:a>s?d+=2:a==s&&(e+=i[l+1]*n[d+1],l+=2,d+=2);return e},I.Vector.prototype.similarity=function(t){return this.dot(t)/this.magnitude()||0},I.Vector.prototype.toArray=function(){for(var t=new Array(this.elements.length/2),e=1,i=0;e<this.elements.length;e+=2,i++)t[i]=this.elements[e];return t},I.Vector.prototype.toJSON=function(){return this.elements},
/*!
 * lunr.stemmer
 * Copyright (C) 2020 Oliver Nightingale
 * Includes code from - http://tartarus.org/~martin/PorterStemmer/js.txt
 */
I.stemmer=(t={ational:"ate",tional:"tion",enci:"ence",anci:"ance",izer:"ize",bli:"ble",alli:"al",entli:"ent",eli:"e",ousli:"ous",ization:"ize",ation:"ate",ator:"ate",alism:"al",iveness:"ive",fulness:"ful",ousness:"ous",aliti:"al",iviti:"ive",biliti:"ble",logi:"log"},n={icate:"ic",ative:"",alize:"al",iciti:"ic",ical:"ic",ful:"",ness:""},s="^("+(r="[^aeiou][^aeiouy]*")+")?"+(a=(o="[aeiouy]")+"[aeiou]*")+r+"("+a+")?$",l="^("+r+")?"+a+r+a+r,d="^("+r+")?"+o,c=new RegExp("^("+r+")?"+a+r),p=new RegExp(l),h=new RegExp(s),u=new RegExp(d),m=/^(.+?)(ss|i)es$/,f=/^(.+?)([^s])s$/,g=/^(.+?)eed$/,v=/^(.+?)(ed|ing)$/,b=/.$/,y=/(at|bl|iz)$/,w=new RegExp("([^aeiouylsz])\\1$"),x=new RegExp("^"+r+o+"[^aeiouwxy]$"),C=/^(.+?[^aeiou])y$/,A=/^(.+?)(ational|tional|enci|anci|izer|bli|alli|entli|eli|ousli|ization|ation|ator|alism|iveness|fulness|ousness|aliti|iviti|biliti|logi)$/,D=/^(.+?)(icate|ative|alize|iciti|ical|ful|ness)$/,E=/^(.+?)(al|ance|ence|er|ic|able|ible|ant|ement|ment|ent|ou|ism|ate|iti|ous|ive|ize)$/,k=/^(.+?)(s|t)(ion)$/,S=/^(.+?)e$/,P=/ll$/,F=new RegExp("^"+r+o+"[^aeiouwxy]$"),R=function(e){var i,o,r,a,s,l,d;if(e.length<3)return e;if("y"==(r=e.substr(0,1))&&(e=r.toUpperCase()+e.substr(1)),s=f,(a=m).test(e)?e=e.replace(a,"$1$2"):s.test(e)&&(e=e.replace(s,"$1$2")),s=v,(a=g).test(e)){var R=a.exec(e);(a=c).test(R[1])&&(a=b,e=e.replace(a,""))}else s.test(e)&&(i=(R=s.exec(e))[1],(s=u).test(i)&&(l=w,d=x,(s=y).test(e=i)?e+="e":l.test(e)?(a=b,e=e.replace(a,"")):d.test(e)&&(e+="e")));return(a=C).test(e)&&(e=(i=(R=a.exec(e))[1])+"i"),(a=A).test(e)&&(i=(R=a.exec(e))[1],o=R[2],(a=c).test(i)&&(e=i+t[o])),(a=D).test(e)&&(i=(R=a.exec(e))[1],o=R[2],(a=c).test(i)&&(e=i+n[o])),s=k,(a=E).test(e)?(i=(R=a.exec(e))[1],(a=p).test(i)&&(e=i)):s.test(e)&&(i=(R=s.exec(e))[1]+R[2],(s=p).test(i)&&(e=i)),(a=S).test(e)&&(i=(R=a.exec(e))[1],s=h,l=F,((a=p).test(i)||s.test(i)&&!l.test(i))&&(e=i)),s=p,(a=P).test(e)&&s.test(e)&&(a=b,e=e.replace(a,"")),"y"==r&&(e=r.toLowerCase()+e.substr(1)),e},function(t){return t.update(R)}),I.Pipeline.registerFunction(I.stemmer,"stemmer"),
/*!
 * lunr.stopWordFilter
 * Copyright (C) 2020 Oliver Nightingale
 */
