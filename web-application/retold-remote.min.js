 ...
 */
I.stemmer=(t={ational:"ate",tional:"tion",enci:"ence",anci:"ance",izer:"ize",bli:"ble",alli:"al",entli:"ent",eli:"e",ousli:"ous",ization:"ize",ation:"ate",ator:"ate",alism:"al",iveness:"ive",fulness:"ful",ousness:"ous",aliti:"al",iviti:"ive",biliti:"ble",logi:"log"},n={icate:"ic",ative:"",alize:"al",iciti:"ic",ical:"ic",ful:"",ness:""},a="^("+(r="[^aeiou][^aeiouy]*")+")?"+(s=(o="[aeiouy]")+"[aeiou]*")+r+"("+s+")?$",l="^("+r+")?"+s+r+s+r,d="^("+r+")?"+o,c=new RegExp("^("+r+")?"+s+r),p=new RegExp(l),h=new RegExp(a),u=new RegExp(d),m=/^(.+?)(ss|i)es$/,f=/^(.+?)([^s])s$/,g=/^(.+?)eed$/,v=/^(.+?)(ed|ing)$/,b=/.$/,y=/(at|bl|iz)$/,w=new RegExp("([^aeiouylsz])\\1$"),x=new RegExp("^"+r+o+"[^aeiouwxy]$"),C=/^(.+?[^aeiou])y$/,A=/^(.+?)(ational|tional|enci|anci|izer|bli|alli|entli|eli|ousli|ization|ation|ator|alism|iveness|fulness|ousness|aliti|iviti|biliti|logi)$/,D=/^(.+?)(icate|ative|alize|iciti|ical|ful|ness)$/,E=/^(.+?)(al|ance|ence|er|ic|able|ible|ant|ement|ment|ent|ou|ism|ate|iti|ous|ive|ize)$/,k=/^(.+?)(s|t)(ion)$/,S=/^(.+?)e$/,P=/ll$/,F=new RegExp("^"+r+o+"[^aeiouwxy]$"),R=function(e){var i,o,r,s,a,l,d;if(e.length<3)return e;if("y"==(r=e.substr(0,1))&&(e=r.toUpperCase()+e.substr(1)),a=f,(s=m).test(e)?e=e.replace(s,"$1$2"):a.test(e)&&(e=e.replace(a,"$1$2")),a=v,(s=g).test(e)){var R=s.exec(e);(s=c).test(R[1])&&(s=b,e=e.replace(s,""))}else a.test(e)&&(i=(R=a.exec(e))[1],(a=u).test(i)&&(l=w,d=x,(a=y).test(e=i)?e+="e":l.test(e)?(s=b,e=e.replace(s,"")):d.test(e)&&(e+="e")));return(s=C).test(e)&&(e=(i=(R=s.exec(e))[1])+"i"),(s=A).test(e)&&(i=(R=s.exec(e))[1],o=R[2],(s=c).test(i)&&(e=i+t[o])),(s=D).test(e)&&(i=(R=s.exec(e))[1],o=R[2],(s=c).test(i)&&(e=i+n[o])),a=k,(s=E).test(e)?(i=(R=s.exec(e))[1],(s=p).test(i)&&(e=i)):a.test(e)&&(i=(R=a.exec(e))[1]+R[2],(a=p).test(i)&&(e=i)),(s=S).test(e)&&(i=(R=s.exec(e))[1],a=h,l=F,((s=p).test(i)||a.test(i)&&!l.test(i))&&(e=i)),a=p,(s=P).test(e)&&a.test(e)&&(s=b,e=e.replace(s,"")),"y"==r&&(e=r.toLowerCase()+e.substr(1)),e},function(t){return t.update(R)}),I.Pipeline.registerFunction(I.stemmer,"stemmer"),
/*!
 * lunr.stopWordFilter
 * Copyright (C) 2020 Oliver Nightingale
 */
