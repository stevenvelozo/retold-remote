 ...
 */
I.stemmer=(t={ational:"ate",tional:"tion",enci:"ence",anci:"ance",izer:"ize",bli:"ble",alli:"al",entli:"ent",eli:"e",ousli:"ous",ization:"ize",ation:"ate",ator:"ate",alism:"al",iveness:"ive",fulness:"ful",ousness:"ous",aliti:"al",iviti:"ive",biliti:"ble",logi:"log"},n={icate:"ic",ative:"",alize:"al",iciti:"ic",ical:"ic",ful:"",ness:""},s="^("+(r="[^aeiou][^aeiouy]*")+")?"+(a=(o="[aeiouy]")+"[aeiou]*")+r+"("+a+")?$",l="^("+r+")?"+a+r+a+r,d="^("+r+")?"+o,c=new RegExp("^("+r+")?"+a+r),p=new RegExp(l),h=new RegExp(s),u=new RegExp(d),m=/^(.+?)(ss|i)es$/,f=/^(.+?)([^s])s$/,g=/^(.+?)eed$/,v=/^(.+?)(ed|ing)$/,b=/.$/,y=/(at|bl|iz)$/,w=new RegExp("([^aeiouylsz])\\1$"),x=new RegExp("^"+r+o+"[^aeiouwxy]$"),C=/^(.+?[^aeiou])y$/,A=/^(.+?)(ational|tional|enci|anci|izer|bli|alli|entli|eli|ousli|ization|ation|ator|alism|iveness|fulness|ousness|aliti|iviti|biliti|logi)$/,D=/^(.+?)(icate|ative|alize|iciti|ical|ful|ness)$/,E=/^(.+?)(al|ance|ence|er|ic|able|ible|ant|ement|ment|ent|ou|ism|ate|iti|ous|ive|ize)$/,k=/^(.+?)(s|t)(ion)$/,S=/^(.+?)e$/,P=/ll$/,F=new RegExp("^"+r+o+"[^aeiouwxy]$"),T=function(e){var i,o,r,a,s,l,d;if(e.length<3)return e;if("y"==(r=e.substr(0,1))&&(e=r.toUpperCase()+e.substr(1)),s=f,(a=m).test(e)?e=e.replace(a,"$1$2"):s.test(e)&&(e=e.replace(s,"$1$2")),s=v,(a=g).test(e)){var T=a.exec(e);(a=c).test(T[1])&&(a=b,e=e.replace(a,""))}else s.test(e)&&(i=(T=s.exec(e))[1],(s=u).test(i)&&(l=w,d=x,(s=y).test(e=i)?e+="e":l.test(e)?(a=b,e=e.replace(a,"")):d.test(e)&&(e+="e")));return(a=C).test(e)&&(e=(i=(T=a.exec(e))[1])+"i"),(a=A).test(e)&&(i=(T=a.exec(e))[1],o=T[2],(a=c).test(i)&&(e=i+t[o])),(a=D).test(e)&&(i=(T=a.exec(e))[1],o=T[2],(a=c).test(i)&&(e=i+n[o])),s=k,(a=E).test(e)?(i=(T=a.exec(e))[1],(a=p).test(i)&&(e=i)):s.test(e)&&(i=(T=s.exec(e))[1]+T[2],(s=p).test(i)&&(e=i)),(a=S).test(e)&&(i=(T=a.exec(e))[1],s=h,l=F,((a=p).test(i)||s.test(i)&&!l.test(i))&&(e=i)),s=p,(a=P).test(e)&&s.test(e)&&(a=b,e=e.replace(a,"")),"y"==r&&(e=r.toLowerCase()+e.substr(1)),e},function(t){return t.update(T)}),I.Pipeline.registerFunction(I.stemmer,"stemmer"),
/*!
 * lunr.stopWordFilter
 * Copyright (C) 2020 Oliver Nightingale
 */
