...
/*!
         ...
         */
k.stemmer=(t={ational:"ate",tional:"tion",enci:"ence",anci:"ance",izer:"ize",bli:"ble",alli:"al",entli:"ent",eli:"e",ousli:"ous",ization:"ize",ation:"ate",ator:"ate",alism:"al",iveness:"ive",fulness:"ful",ousness:"ous",aliti:"al",iviti:"ive",biliti:"ble",logi:"log"},n={icate:"ic",ative:"",alize:"al",iciti:"ic",ical:"ic",ful:"",ness:""},a="^("+(s="[^aeiou][^aeiouy]*")+")?"+(r=(o="[aeiouy]")+"[aeiou]*")+s+"("+r+")?$",c="^("+s+")?"+r+s+r+s,l="^("+s+")?"+o,h=new RegExp("^("+s+")?"+r+s),d=new RegExp(c),p=new RegExp(a),u=new RegExp(l),f=/^(.+?)(ss|i)es$/,g=/^(.+?)([^s])s$/,m=/^(.+?)eed$/,v=/^(.+?)(ed|ing)$/,b=/.$/,D=/(at|bl|iz)$/,y=new RegExp("([^aeiouylsz])\\1$"),w=new RegExp("^"+s+o+"[^aeiouwxy]$"),A=/^(.+?[^aeiou])y$/,I=/^(.+?)(ational|tional|enci|anci|izer|bli|alli|entli|eli|ousli|ization|ation|ator|alism|iveness|fulness|ousness|aliti|iviti|biliti|logi)$/,T=/^(.+?)(icate|ative|alize|iciti|ical|ful|ness)$/,P=/^(.+?)(al|ance|ence|er|ic|able|ible|ant|ement|ment|ent|ou|ism|ate|iti|ous|ive|ize)$/,x=/^(.+?)(s|t)(ion)$/,S=/^(.+?)e$/,C=/ll$/,L=new RegExp("^"+s+o+"[^aeiouwxy]$"),R=function(e){var i,o,s,r,a,c,l;if(e.length<3)return e;if("y"==(s=e.substr(0,1))&&(e=s.toUpperCase()+e.substr(1)),a=g,(r=f).test(e)?e=e.replace(r,"$1$2"):a.test(e)&&(e=e.replace(a,"$1$2")),a=v,(r=m).test(e)){var R=r.exec(e);(r=h).test(R[1])&&(r=b,e=e.replace(r,""))}else a.test(e)&&(i=(R=a.exec(e))[1],(a=u).test(i)&&(c=y,l=w,(a=D).test(e=i)?e+="e":c.test(e)?(r=b,e=e.replace(r,"")):l.test(e)&&(e+="e")));return(r=A).test(e)&&(e=(i=(R=r.exec(e))[1])+"i"),(r=I).test(e)&&(i=(R=r.exec(e))[1],o=R[2],(r=h).test(i)&&(e=i+t[o])),(r=T).test(e)&&(i=(R=r.exec(e))[1],o=R[2],(r=h).test(i)&&(e=i+n[o])),a=x,(r=P).test(e)?(i=(R=r.exec(e))[1],(r=d).test(i)&&(e=i)):a.test(e)&&(i=(R=a.exec(e))[1]+R[2],(a=d).test(i)&&(e=i)),(r=S).test(e)&&(i=(R=r.exec(e))[1],a=p,c=L,((r=d).test(i)||a.test(i)&&!c.test(i))&&(e=i)),a=d,(r=C).test(e)&&a.test(e)&&(r=b,e=e.replace(r,"")),"y"==s&&(e=s.toLowerCase()+e.substr(1)),e},function(t){return t.update(R)}),k.Pipeline.registerFunction(k.stemmer,"stemmer"),
/*!
         * lunr.stopWordFilter
         * Copyright (C) 2020 Oliver Nightingale
         */
